...
function BatchPanel({
  ...
  return (
    <div className="rounded-[2px] border border-[#E8E2D8] bg-[#F8F5F2] p-5 space-y-4">
        ...
        <div className="space-y-2">
          ...
          {waitlistDone ? (
            ...
            <button
              ...
              className="w-full text-xs text-[#C4622D] hover:text-[#A84F22] transition-colors text-center"
            >
              Join waitlist →
            </button>
          )}
          ...
          <button
            ...
            className={`w-full py-3 rounded-[2px] text-sm font-medium tracking-wide transition-all ${
              preordered
                ...
                : "bg-[#C4622D] hover:bg-[#A84F22] text-white"
            }`}
          >
...
function WaitlistPanel() {
  ...
  return (
    <div className="rounded-[2px] border border-[#E8E2D8] bg-[#F8F5F2] p-5 space-y-3">
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col bg-white">
        <nav className="sticky top-0 z-50 bg-white border-b border-stone-200 px-6 md:px-10 py-3.5 flex items-center justify-between">
          <Link href="/" className="text-stone-500 hover:text-[#2A1508] text-xs tracking-wide transition-colors">
            ← Marketplace
          </Link>
          <Link href="/">
            <Logo height={36} />
        ...
        <div className="px-6 md:px-10 pt-12 pb-14 animate-pulse bg-stone-50">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-stone-200 px-6 md:px-10 py-3.5 flex items-center justify-between">
        <Link
          href="/"
          className="text-stone-500 hover:text-[#2A1508] transition-colors text-xs tracking-wide"
        >
          ← Marketplace
        </Link>
      ...
      {/* ── Hero ────────────────────────────────────────────────────────────── */}
      <section className="bg-white px-6 md:px-10 pt-10 pb-8 border-b border-[#E8E2D8]">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2.5 mb-4">
            <Link
              href={`/roaster/${slugify(product.roaster)}`}
              className="text-[10px] tracking-widest uppercase text-[#C4622D] font-normal hover:text-[#A84F22] transition-colors"
            >
              {product.roaster}
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div
              ...
              style={{ backgroundColor: "#F0EBE3", aspectRatio: "4/3" }}
            >
              <p className="text-[#8C7B6E] text-xs font-light tracking-wide">Product photo</p>
            </div>

            <p className="text-[#2A1508] text-sm leading-relaxed font-light">{product.description}</p>
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-stone-100">
              <Link
                href={`/roaster/${slugify(product.roaster)}`}
                className="text-[11px] text-[#C4622D] hover:text-[#A84F22] transition-colors font-light"
              >
                {product.roaster} · Visit roaster →
              </Link>
            </div>
