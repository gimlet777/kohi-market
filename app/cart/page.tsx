      ...
      <div className="flex-1 px-6 md:px-10 py-10 max-w-2xl mx-auto w-full">
        ...
        {cart.items.length === 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <Link
              href="/"
              className="inline-block bg-[#C4622D] hover:bg-[#B0561A] text-white text-sm px-6 py-3 rounded-[2px] transition-colors"
            >
              Browse coffees
            </Link>
          </div>
          ...
          <div className="space-y-3">
            ...
            {cart.items.map(item => (
              <div
                key={item.cartItemId}
                className="bg-white border border-[rgba(42,21,8,0.07)] rounded p-5"
              >
                ...
                <div className="flex items-center justify-between mt-4 pt-4 border-t border-stone-100">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="w-11 h-11 rounded-[2px] border border-[rgba(42,21,8,0.07)] flex items-center justify-center text-stone-400 hover:border-[#C4622D] hover:text-[#C4622D] transition-colors text-lg leading-none"
            ...
            {/* Order summary */}
            <div className="bg-white border border-[rgba(42,21,8,0.07)] rounded p-6 mt-4">
              ...
              <Link
                ...
                className="block w-full mt-5 bg-[#2A1508] hover:bg-[#3a2010] text-white py-3.5 rounded-[2px] text-sm font-medium tracking-wide transition-colors text-center"
              >
                Proceed to Checkout
              </Link>
